...
SECRET_KEY = 'django-insecure-y^ure@3rkguc(qr%3)=6o5g_eg!l4w04nus-exi_&ty#o^+5wr'
...
INSTALLED_APPS = [
    ...
    "article", #oluşturduğumuz appin adını buraya yazıyoruz
    "user", # oluşturduğumuz appin adını yazmayı unutma
    'crispy_forms',
    "ckeditor",
...
TEMPLATES = [
    {
        ...
        'DIRS': ["templates"],# html klasörünü aratmak için 'DIRS' içine html belgelerinin olduğu klasörün adını buraya yazıyoruz.
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
} # ckeditörün çalışabilmesi için bunu sayfalara eklediğim django-ckeditor sayfasını inceleyerek anlayabilirsin
#bunun amacı makale ekle kısmında kaynak bölümüne tıkladığımız kod yazabileceğiz eğer bunları yapmasaydık orada kod yazarken hatalarla karşılaşacaktık
